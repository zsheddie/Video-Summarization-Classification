...
class VideoDataset(Dataset):
    def __init__(self, video_folder, max_frames=220, resize_shape=(224, 224)):
...
model.load_state_dict(torch.load('E:/KIT/FZI_hiwi/Project/saved_models/CLC_003.pth'))
model.eval()
...
np.savez_compressed('./saved_summaries/CLC_003.npz', arr1 = pred, arr2 = test)
